	...
	return (
		<Section>
			...
			<Description data-scroll data-scroll-speed="2">
				<InfoText>
					Focusing on creating neat <span>Design Systems</span>, <span>Animations</span> and{' '}
					<span>Interactions</span>. Working together with team members to get all the design
					processes in place.
				</InfoText>
			</Description>
			...
			<Grid data-scroll data-scroll-speed="2">
				...
				<div>
					...
					<Paragraph fullWidth>Well-made website require effort and comprehension.</Paragraph>
				</div>
				<div>
				...
				<div>
					...
					<Paragraph>
						Identify and tackle problems to maximize the effectiveness of the outcome.
					</Paragraph>
				</div>
			</Grid>
		</Section>
